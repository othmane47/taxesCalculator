...
class RounderUtilTest {
    ...
    /**
     * Should not round 1.05.
     */
    @Test
    public void shouldNotRound1_05() {
        assertThat(RounderUtil.roundAmountToTheNearestFiveCents(BigDecimal.valueOf(1.05))).isEqualTo(BigDecimal.valueOf(1.05).setScale(2));
    }
